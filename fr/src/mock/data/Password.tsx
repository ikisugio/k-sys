...
const validationSchema = Yup.object().shape({
    password: Yup.string().required('パスワード Required'),
...
const パスワード = ({ data }: { data?: LoginHistory[] }) => {
    const onFormSubmit = (
        values: PasswordFormModel,
        setSubmitting: (isSubmitting: boolean) => void
    ) => {
        toast.push(<Notification title={'パスワード updated'} type="success" />, {
